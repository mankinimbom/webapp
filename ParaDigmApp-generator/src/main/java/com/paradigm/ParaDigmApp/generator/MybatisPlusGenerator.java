package com.paradigm.ParaDigmApp.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.paradigm.ParaDigmApp";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/ParaDigmApp-model"),
        mapper("/ParaDigmApp-dao"),
        mapperxml("/ParaDigmApp-web"),
        service("/ParaDigmApp-service"),
        web("/ParaDigmApp-web"),
        ;
